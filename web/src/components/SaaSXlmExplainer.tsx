      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <h2 className="font-heading text-3xl font-bold text-white tracking-tight leading-none">
            Understanding <span className="text-transparent bg-clip-text bg-gradient-to-r from-neoncyan to-neongreen text-glow-cyan">XLM (Stellar Lumens)</span>
          </h2>
        ...
        {/* Right Column: Live Price Card as a Card */}
