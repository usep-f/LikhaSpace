    ...
    <section className={`py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-white/5 ${className}`}>
      <div className="text-center mb-12">
        <h2 className="font-heading text-3xl font-bold text-white tracking-tight">
          Who Is <span className="text-neoncyan text-glow-cyan">LikhaSpace</span> For?
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-8 rounded-2xl glass-card border border-white/5 hover:border-hotpink/30 hover:shadow-[0_0_30px_rgba(255,0,127,0.1)] cursor-pointer transition-all duration-300">
        ...
        <div className="p-8 rounded-2xl glass-card border border-white/5 hover:border-neoncyan/30 hover:shadow-[0_0_30px_rgba(0,243,255,0.1)] cursor-pointer transition-all duration-300">
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
