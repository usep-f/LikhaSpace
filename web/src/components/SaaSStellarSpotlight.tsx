      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
        ...
        <AnimatedSection className="lg:col-span-7 space-y-6 text-left">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl font-bold text-white tracking-tight leading-none">
            Powered by the <span className="text-transparent bg-clip-text bg-gradient-to-r from-neoncyan to-neongreen text-glow-cyan text-shimmer-gradient">Stellar Network</span>
          </h2>
          ...
          <AnimatedSection stagger className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
            {/* Benefit 1 */}
            <AnimatedItem>
        ...
        <AnimatedSection delay={0.2} className="lg:col-span-5 w-full flex flex-col items-center lg:h-full">
